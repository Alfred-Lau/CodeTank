...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    csslint: {
      ...
      src: ['dist/css/bootstrap.css', 'dist/css/bootstrap-theme.css', 'docs/assets/css/docs.css', 'docs/examples/**/*.css']
    },
    ...
    uglify: {
      ...
      customize: {
        ...
        src: ['docs/assets/js/vendor/less.min.js', 'docs/assets/js/vendor/jszip.min.js', 'docs/assets/js/vendor/uglify.min.js', 'docs/assets/js/vendor/blob.js', 'docs/assets/js/vendor/filesaver.js', 'docs/assets/js/raw-files.min.js', 'docs/assets/js/customizer.js'],
      ...
      docsJs: {
        ...
        src: ['docs/assets/js/vendor/holder.js', 'docs/assets/js/application.js'],
    ...
    cssmin: {
      compress: {
        ...
        src: ['docs/assets/css/docs.css', 'docs/assets/css/pygments-manni.css'],
    ...
    usebanner: {
      dist: {
        ...
        files: {
          src: ['dist/css/<%= pkg.name %>.css', 'dist/css/<%= pkg.name %>.min.css', 'dist/css/<%= pkg.name %>-theme.css', 'dist/css/<%= pkg.name %>-theme.min.css']
        }
      }
    },
